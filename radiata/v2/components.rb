...
(led_names-main_ring_leds).each_with_index do |led_name, idx|
  angle = 90 + (idx - 60) * -30
  puts "move #{led_name}_1 (P 37.5 #{angle-7.5});"
  puts "rotate =R#{angle-7.5+270} #{led_name}_1;"
  puts "move #{led_name}_2 (P 37.5 #{angle+7.5});"
  puts "rotate =R#{angle+7.5+270} #{led_name}_2;"
end
